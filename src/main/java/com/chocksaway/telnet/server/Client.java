...
import com.chocksaway.telnet.Util;
import com.chocksaway.telnet.command.CDHandler;
import com.chocksaway.telnet.command.CommandHandler;
import com.chocksaway.telnet.command.CommandHandlerFactory;
import com.chocksaway.telnet.command.ExitHandler;

/**
 * Created by davenm05 on 12/12/2016.
 */
public class Client implements Runnable {
     ...
     * @param socket
     */
    public Client(final Socket socket, String homeDir) {
        this.socket = socket;
